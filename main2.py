...
class Main(Widget):
    ...
    btnClosedPanelModel = ObjectProperty(None)
    ...
    def btnModelTask(self):
        ...
        self.btnClosedPanelModel.bind(on_press=self.resetPanelModel)
    ...
    def addWidget(self):
        ...
        if self.turnOn:
            ...
            # self.add_widget(self.labelTimeProcess)
            # self.labelTimeProcess.text = f"{_CalculationTime.timeProcessing():.3}"
